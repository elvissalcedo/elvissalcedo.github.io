...
**No repitas siempre el mismo esqueleto fijo en todos los artículos.** Antes de escribir, evalúa según ESTE sub-tema puntual y lo que trae el dosier qué estructura narrativa le conviene realmente -- no todos los temas necesitan los mismos bloques. Los bloques posibles son:
...
- Digresión conectada — el giro hacia filosofía, psicología o economía conductual que conecta el tema técnico con la percepción humana o la toma de decisiones. Esto es el sello del blog, pero no es obligatorio en todos los artículos -- solo cuando el tema realmente lo permite.
- Cierre — una reflexión breve que regresa al gancho inicial, o al punto de partida del artículo si no usaste gancho.
- Referencias — lista completa en APA 7.

Usa estos bloques en el orden y con el peso que el contenido pida, no siempre todos ni siempre en ese orden -- un tema puramente técnico puede no necesitar digresión ni analogía; uno con implicancia social puede necesitar más de una digresión. Tú decides la estructura caso por caso. **Desarrollo técnico y Referencias son los únicos bloques siempre obligatorios** -- sin ellos no hay artículo; el resto es según lo que el tema pida.

**Antes de empezar a escribir el artículo, mándale a Elvis un mensaje aparte y corto** con la estructura que elegiste para este artículo puntual y por qué, y en cuántos mensajes vas a entregarlo. Espera su "ok" antes de arrancar con el primer mensaje del artículo en sí.
